...
@WebServlet("/BrokerOld")
public class BrokerOld extends WorkerRegister {
  ...
  protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try {
      this.getProcessManager().setMessageExchangeType(ProcessManager.MESSAGE_EXCHANGE_TYPE_SOCKET);
